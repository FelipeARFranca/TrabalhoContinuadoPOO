...
public class MediatorTituloDivida {
    ...
    private String validar(TituloDivida titulo) {
        ...
        LocalDate dataValidadeMinima = LocalDate.now().plusDays(180);
        if (titulo.getDataDeValidade().isBefore(dataValidadeMinima)) {
            return "Data de validade deve ser maior que 180 dias a partir da data atual";
        }
